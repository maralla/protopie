...
# ruff: noqa: S101, S603, PLW1510, TRY300, PT006, E501, W293, F841
...
class TestInvalidFeatures:
    ...
    @pytest.mark.parametrize("source,description,error_pattern", [
    ...
    def test_invalid_feature_rejected(self, source: str, description: str, error_pattern: str | None) -> None:
...
class TestEdgeCases:
    ...
    @pytest.mark.parametrize("source,description", [
        ...
        # Many fields
        ('syntax = "proto3";\nmessage M { ' + ' '.join(f'string f{i} = {i};' for i in range(1, 101)) + ' }\n',
         "100 fields"),
        ...
        # Many enum values
        ('syntax = "proto3";\nenum E { ' + ' '.join(f'V{i} = {i};' for i in range(100)) + ' }\n',
         "100 enum values"),
